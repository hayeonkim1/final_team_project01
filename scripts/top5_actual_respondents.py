"""Top-K predicted preference profiles from actual survey respondents (exclude 10대)."""
...
OUTPUT = ROOT / "data" / "survey_analysis" / "ml_results" / "top5_feature_combinations_actual.csv"
TOP_K = 5
EXCLUDE_AGE = "10대"
...
def main() -> None:
    ...
    result = result.sort_values("predicted_prob_pct", ascending=False).head(TOP_K)
